...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "_hello",
        "sources": [
            "C:\\Users\\user\\AppData\\Local\\Programs\\Python\\Python37\\cython\\_hello.pyx"
        ]
    },
    "module_name": "_hello"
}
...
static const char __pyx_k_hello_pyx[] = "_hello.pyx";
...
static PyObject *__pyx_pf_6_hello_say_hello_to(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_6_hello_1say_hello_to(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyMethodDef __pyx_mdef_6_hello_1say_hello_to = {"say_hello_to", (PyCFunction)__pyx_pw_6_hello_1say_hello_to, METH_NOARGS, 0};
static PyObject *__pyx_pw_6_hello_1say_hello_to(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("say_hello_to (wrapper)", 0);
  __pyx_r = __pyx_pf_6_hello_say_hello_to(__pyx_self);
...
static PyObject *__pyx_pf_6_hello_say_hello_to(CYTHON_UNUSED PyObject *__pyx_self) {
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("_hello.say_hello_to", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
 ...
 *     print("Hello World")
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_hello_pyx, __pyx_n_s_say_hello_to, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "_hello")) {
      if (unlikely(PyDict_SetItemString(modules, "_hello", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     print("Hello World")
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6_hello_1say_hello_to, NULL, __pyx_n_s_hello); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
